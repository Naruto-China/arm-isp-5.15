...
struct lensConfig dw9714Cfg = {
    .lensName = "dw9714",
    .lensFunc.pfn_lens_move = vcm_set_pos_dw9714,
    .lensFunc.pfn_lens_stop = NULL,
    .lensFunc.pfn_lens_is_moving = vcm_is_moving_dw9714,
    .lensFunc.pfn_lens_get_pos = NULL,
    .lensFunc.pfn_lens_write_register = NULL,
    .lensFunc.pfn_lens_read_register = NULL,
    .lensFunc.pfn_lens_get_parameters = vcm_get_param_dw9714,
    .lensFunc.pfn_lens_move_zoom = NULL,
    .lensFunc.pfn_lens_is_zooming = NULL,
    .lens_set_entity = vcm_set_ent_dw9714,
};
